[begin] (Frenzy 1.0)
	[exec]	(Консоль)	{rxvt}				</usr/local/frenzy/icons/fluxbox/terminal3_16x16.xpm>
	[exec]	(Запуск)		{thinglaunch}

[submenu] (Работа с файлами) 	</usr/local/frenzy/icons/fluxbox/folder_grey.png>
	[exec]	(xterm)		{xterm}				</usr/local/frenzy/icons/fluxbox/xconsole_16x16.xpm>
	[exec]	(Deco)		{rxvt -e deco}
	[exec]	(MC)		{rxvt -e mc}
	[exec]	(MtoolsFM)	{mtoolsfm}			</usr/local/frenzy/icons/fluxbox/floppy_16x16.xpm>
	[exec]	(gtkfind)	{gtkfind}			</usr/local/frenzy/icons/fluxbox/find_16x16.xpm>
#	[separator]
#	[exec]	(mrxvt)		{mrxvt}				</usr/local/frenzy/icons/fluxbox/terminal_16x16.xpm>
#	[exec]	(XNC)		{xnc}				</usr/local/frenzy/icons/fluxbox/app3_16x16.xpm>
	[submenu] (Архиваторы) 	</usr/local/frenzy/icons/fluxbox/folder_grey.png>
#		[exec]	(xarchive)	{xarchive}			</usr/local/frenzy/icons/fluxbox/ark_16x16.xpm>
...
#			[exec]	(dynamite)	{rxvt -e launch dynamite}
			[exec]	(gzrecover)	{rxvt -e launch gzrecover}
			[exec]	(ha)		{rxvt -e launch ha}
#			[exec]	(lbrate)	{rxvt -e launch lbrate -h}
...
#			[exec]	(unshield)	{rxvt -e launch unshield -h}
...
#		[separator]
#		[exec]	(SciTE)		{SciTE}				</usr/local/frenzy/icons/fluxbox/notes_16x16.xpm>
#		[exec]	(le)		{rxvt -e le}
#		[exec]	(nano)		{rxvt -e nano}
	[end]
	[submenu] (Просмотр) 	</usr/local/frenzy/icons/fluxbox/folder_grey.png>
#		[exec]	(DjVu viewer)	{djview}			<>
#		[exec]	(PDF viewer)	{xpdf}				</usr/local/frenzy/icons/fluxbox/pdf_16x16.xpm>
#		[exec]	(K CHM viewer)	{kchmviewer}			<>
#		[separator]
...
#		[exec]	(slrn)		{rxvt -e slrn}
		[exec]	(sendEmail)	{rxvt -e launch sendEmail}
	[end]
	[submenu] (ICQ, IRC, Jabber) 	</usr/local/frenzy/icons/fluxbox/folder_grey.png>
		[exec]	(centericq)	{rxvt -e centericq}
#		[exec]	(micq)		{rxvt -e launch micq}
#		[exec]	(Licq)		{licq}				</usr/local/frenzy/icons/fluxbox/icq_16x16.xpm>
#		[exec]	(SIM)		{sim}				</usr/local/frenzy/icons/fluxbox/icq_16x16.xpm>
		[separator]
		[exec]	(irssi)		{rxvt -e irssi}
#		[exec]	(X-Chat)	{xchat}				</usr/local/frenzy/icons/fluxbox/xchat3_16x16.xpm>
		[separator]
#		[exec]	(PSI)		{psi}				</usr/local/frenzy/icons/fluxbox/psi_16x16.xpm>
		[exec]	(mcabber)	{rxvt -e launch mcabber -h}
		[separator]
...
#		[exec]	(cutecom)	{cutecom}			</usr/local/frenzy/icons/fluxbox/xterm_16x16.xpm>
...
#		[exec]	(xisp)		{xisp}				</usr/local/frenzy/icons/fluxbox/xisp_16x16.xpm>
		[exec]	(yawmppp)	{yawmppp}			</usr/local/frenzy/icons/fluxbox/isp_16x16.xpm>
		[exec]	(ppptraf)	{rxvt -e launch ppptraf}
#		[exec]	(pppload)	{pppload}			<>
		[separator]
	...
	[submenu] (Беспроводная сеть) 	</usr/local/frenzy/icons/fluxbox/folder_grey.png>
		[exec]	(aircrack)	{rxvt -e launch aircrack}
		[exec]	(ap-config)	{rxvt -e launch ap-config}
		[exec]	(kismet)	{rxvt -e launch kismet}
		[exec]	(wiconf)	{rxvt -e launch wiconf.pl}
		[exec]	(wistumbler)	{rxvt -e launch wistumbler2 -h}
...
#		[exec]	(ike-scan)	{rxvt -e launch ike-scan}
	[end]
	[separator]
	...
	[submenu] (Мониторинг) 		</usr/local/frenzy/icons/fluxbox/folder_grey.png>
		...
		[exec]	(nettop)	{rxvt -e launch nettop --help}
...
#		[exec]	(symbion)	{rxvt -e launch symbion}
	...
	[end]
#	[submenu] (Firewall) 		</usr/local/frenzy/icons/fluxbox/folder_grey.png>
#		[exec]	(qtfw)		{qtfw}				</usr/local/frenzy/icons/fluxbox/app3_16x16.xpm>
#		[exec]	(IPFW graph)	{ipfw-graph}			</usr/local/frenzy/icons/fluxbox/app3_16x16.xpm>
#	[end]
[end]
...
#		[exec]	(Jags)		{jags}				</usr/local/frenzy/icons/fluxbox/samba_16x16.xpm>
...
#		[exec]	(Samba Sentinel)	{SambaSentinel}		</usr/local/frenzy/icons/fluxbox/samba_16x16.xpm>
	[end]
...
#		[exec]	(gresolver)	{gresolver}			</usr/local/frenzy/icons/fluxbox/app3_16x16.xpm>
		[separator]
	...
	[submenu] (IP) 			</usr/local/frenzy/icons/fluxbox/folder_grey.png>
		...
		[exec]	(scapy)		{rxvt -e launch scapy}
...
#		[exec]	(queso)		{rxvt -e launch queso}
	[end]
...
#		[exec]	(GTK portscan)	{gtkportscan}			</usr/local/frenzy/icons/fluxbox/app3_16x16.xpm>
		[exec]	(knocker)	{rxvt -e launch knocker -h}
		[exec]	(portscanner)	{rxvt -e launch portscanner}
...
#		[exec]	(Spike-Proxy)	{rxvt -e spkproxy.sh}
#		[exec]	(unicornscan)	{rxvt -e launch unicornscan}
#		[exec]	(yersinia)	{rxvt -e launch yersinia}
	[end]
	[submenu] (Снифферы) 		</usr/local/frenzy/icons/fluxbox/folder_grey.png>
		[exec]	(ethereal)	{ethereal}			</usr/local/frenzy/icons/fluxbox/ethereal_16x16.xpm>
...
#		[exec]	(hafiye)	{rxvt -e launch hafiye}
...
#			[exec]	(ipsumdump)	{rxvt -e launch ipsumdump -h}
		...
		[submenu] (Извлечение данных) 	</usr/local/frenzy/icons/fluxbox/folder_grey.png>
			...
			[exec]	(vomit)		{rxvt -e launch vomit -h}
		[end]
	[end]
...
#		[exec]	(scanlogd)	{rxvt -e launch scanlogd -h}
#		[exec]	(smurflog)	{rxvt -e launch smurflog}
...
[submenu] (Безопасность) 	</usr/local/frenzy/icons/fluxbox/folder_grey.png>
	...
	[submenu] (Пароли) 		</usr/local/frenzy/icons/fluxbox/folder_grey.png>
		[submenu] (Подбор - локальный) 		</usr/local/frenzy/icons/fluxbox/folder_grey.png>
			...
			[exec]	(pwl9x)		{rxvt -e launch pwl9x}
...
#		[exec]	(ghasher)	{ghasher}			</usr/local/frenzy/icons/fluxbox/app3_16x16.xpm>
#		[exec]	(md4coll)	{rxvt -e launch md4coll}
#		[exec]	(md5coll)	{rxvt -e launch md5coll}
	[end]
...
[submenu] (Система) 	</usr/local/frenzy/icons/fluxbox/folder_grey.png>
	[submenu] (Оборудование)	</usr/local/frenzy/icons/fluxbox/folder_grey.png>
		[exec]	(gkrellm)	{gkrellm}			</usr/local/frenzy/icons/fluxbox/hwinfo_16x16.xpm>
...
#		[exec]	(bbapm)		{bbapm}				</usr/local/frenzy/icons/fluxbox/hwinfo_16x16.xpm>
		[separator]
...
#		[exec]	(cdf)		{rxvt -e launch cdf}
	...
	[submenu] (Файловая система)	</usr/local/frenzy/icons/fluxbox/folder_grey.png>
		[submenu] (Создание)	</usr/local/frenzy/icons/fluxbox/folder_grey.png>
			...
			[exec]	(makefs XFS)	{rxvt -e launch mkfs.xfs}
		...
		[submenu] (Проверка)	</usr/local/frenzy/icons/fluxbox/folder_grey.png>
			...
			[exec]	(fsck XFS)	{rxvt -e launch fsck.xfs}
	...
	[submenu] (Тестирование) 	</usr/local/frenzy/icons/fluxbox/folder_grey.png>
		...
		[separator]
#		[exec]	(gtkperf)	{gtkperf}			</usr/local/frenzy/icons/fluxbox/app3_16x16.xpm>
	...
	[submenu] (Работа с log-файлами)		</usr/local/frenzy/icons/fluxbox/folder_grey.png>
		[exec]	(abck)		{rxvt -e launch abck -h}
...
#		[exec]	(qtpkg)		{qtpkg}				</usr/local/frenzy/icons/fluxbox/freebsd_16x16.xpm>
		[separator]
		[exec]	(csup)		{rxvt -e launch csup}
	[end]
	[submenu] (Запись CD)	</usr/local/frenzy/icons/fluxbox/folder_grey.png>
#		[exec]	(graveman)	{graveman}			</usr/local/frenzy/icons/fluxbox/xcd_16x16.xpm>
	...
	[end]
#	[submenu] (Эмуляторы) 	</usr/local/frenzy/icons/fluxbox/folder_grey.png>
#		[exec]	(qemu)		{rxvt -e launch qemu}	</usr/local/frenzy/icons/fluxbox/app3_16x16.xpm>
#		[exec]	(dosbox)	{dosbox}		</usr/local/frenzy/icons/fluxbox/ms-dos_16x16.xpm>	</usr/local/frenzy/icons/fluxbox/windows_16x16.xpm>
#	[end]
	[submenu] (Разработка) 	</usr/local/frenzy/icons/fluxbox/folder_grey.png>
		[exec]	(gcc)		{rxvt -e launch gcc --help}
		[exec]	(nasm)		{rxvt -e launch nasm -h}
...
#		[exec]	(XMMS)		{xmms}			</usr/local/frenzy/icons/fluxbox/xmms_16x16.xpm>
		[exec]	(mp3blaster)	{rxvt -e mp3blaster}
		[exec]	(mpg123)	{rxvt -e launch mpg123}
#		[exec]	(moc)		{rxvt -e mocp}
#		[exec]	(aumix)		{xaumix}		</usr/local/frenzy/icons/fluxbox/multimedia_16x16.xpm>
#		[exec]	(mikmod)	{rxvt -e mikmod}
	...
	[submenu] (Графика) 	</usr/local/frenzy/icons/fluxbox/folder_grey.png>
		...
		[exec]	(xli)		{rxvt -e launch xli}
	[end]
#	[exec]	(MPlayer)	{gmplayer}			</usr/local/frenzy/icons/fluxbox/mplayer_16x16.xpm>
[end]
...
[submenu] (Настройка) 	</usr/local/frenzy/icons/fluxbox/folder_grey.png>
	...
	[exec]	(GTK2 theme switch)	{gtk2-theme-switch}	</usr/local/frenzy/icons/fluxbox/app3_16x16.xpm>
	[exec]	(gxset)			{gxset}			</usr/local/frenzy/icons/fluxbox/app3_16x16.xpm>
#	[exec]	(QT config)		{qtconfig}		</usr/local/frenzy/icons/fluxbox/app3_16x16.xpm>
